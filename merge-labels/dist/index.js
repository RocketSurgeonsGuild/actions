...
const readFile$ = (0, rxjs_1.bindNodeCallback)(fs_1.readFile);
function mergeData(files) {
    return __awaiter(this, void 0, void 0, function* () {
        const result = new Map();
        for (const item of files) {
            (0, core_1.debug)(`reading ${item}`);
            const content = yield (0, rxjs_1.lastValueFrom)(readFile$(item).pipe((0, operators_1.map)(z => z.toString())));
...
var Subscription_1 = __nccwpck_require__(3540);
...
var combineLatestAll_1 = __nccwpck_require__(3255);
...
var pluck_1 = __nccwpck_require__(9592);
...
var timeoutWith_1 = __nccwpck_require__(1308);
...
const mergeData_1 = __nccwpck_require__(9020);
const rxjs_1 = __nccwpck_require__(1752);
const writeFile$ = (0, rxjs_1.bindNodeCallback)(fs_1.writeFile);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const globStrings = (0, core_1.getInput)('files', { required: true }).split(',');
            const output = (0, core_1.getInput)('output', { required: true });
            const files = [];
            for (const fileGlob of globStrings) {
                const glob = yield (0, glob_1.create)(fileGlob);
                files.push(...(yield glob.glob()));
            }
            const data = yield (0, mergeData_1.mergeData)(files);
            (0, core_1.debug)(`writing ${output}`);
            yield (0, rxjs_1.lastValueFrom)(writeFile$((0, path_1.resolve)(output), (0, js_yaml_1.dump)(data)));
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
        }
        catch (error) {
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(7627);
